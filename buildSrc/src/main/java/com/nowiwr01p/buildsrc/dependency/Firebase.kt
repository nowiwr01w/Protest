...
import com.nowiwr01p.buildsrc.dependency.Firebase.Version.PUSH_VERSION

object Firebase {

    const val AUTH = "com.google.firebase:firebase-auth-ktx:$AUTH_VERSION"
    const val PUSH = "com.google.firebase:firebase-messaging-ktx:$PUSH_VERSION"
