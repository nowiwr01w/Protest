...
class MeetingsNavigatorImpl: MeetingsNavigator {
    ...
    override fun graph(builder: NavGraphBuilder, navigator: Navigator) {
        builder.navigation(MeetingsScreen.MeetingsMainScreen.route, MeetingsScreen.MeetingsMainScreen.rootRoute) {
            MeetingsScreen.MeetingsMainScreen.createScreen(builder, navigator)
        }
    }
}